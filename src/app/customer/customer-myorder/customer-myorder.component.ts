...
export class CustomerMyOrderComponent implements OnInit {
  ...
  ionViewWillEnter() {
    ...
    this.orderDetails = {
      ...
      "response": [
        {
          "_id": "6182946e10dc024174739309",
          "orderPlacedDate": "2021-11-03T13:53:50.615Z",
          "vendorName": "Skandha Veg MART",
          "expectedDeliveryDate": "2021-11-03T13:51:49.619Z",
          "grandTotalPrice": 140,
          "orderedItems": [
            {
              "itemName": "Sambar Onion",
              "selectedUnit": "KG",
              "selectedQuantity": 1,
              "selectedItemPrice": 50,
              "noOfquantity": 1,
        ...
        {
          "_id": "618298f4facea155680d2042",
          "orderPlacedDate": "2021-11-03T14:13:08.202Z",
          "vendorName": "Skandha Veg MART",
          "expectedDeliveryDate": "2021-11-03T14:11:05.146Z",
          "grandTotalPrice": 140,
          "orderedItems": [
            {
              "itemName": "Sambar Onion",
